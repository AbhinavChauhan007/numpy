...
def btnSquareRoot():
    global operator
    sqrrt = math.sqrt(float(operator))
    text_input.set(sqrrt)
    operator = ""
...
# Top line
btnPi = Button(cal, padx=13, bd=8, fg="black", font=('arial', 20, 'bold'),
               text="π", bg="Honeydew3", command=lambda: btnClick("3.14159265359")).grid(row=1,
                                                                                  column=0),

btnSquareRoot = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
                       text="√", bg="Honeydew3", command=lambda: btnSquareRoot).grid(row=1, column=1)
...
btnClear = Button(cal, padx=16, bd=8, fg="black", font=('arial', 20, 'bold'),
                     text="C", bg="Honeydew3",command=btnClearDisplay).grid(row=5, column=2)
